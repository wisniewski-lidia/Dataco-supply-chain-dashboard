# Lieferketten-Analyse Dashboard – DataCo Supply Chain Dataset
...
- Umsatz nach Land (interaktive Map)  
- Umsatzentwicklung im Zeitverlauf  
- Verteilung nach Kundensegmenten  
- Matrix-Übersicht nach Ländern (Anzahl Aufträge, Umsatz, Verspätungsquote)

**Tools & Techniken**  
- Power BI Service (online)  
- Datenimport & grundlegende Bereinigung  
...
Erstellt Januar 2026 als persönliches Portfolio-Projekt.
